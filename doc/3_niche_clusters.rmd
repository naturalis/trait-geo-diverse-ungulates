...
overlap.file <- paste(REPO_HOME, '/results/maxent/gowers_overlap_raw_occurencepoints.csv', sep = '')
# load data
...
```{r omi}
omi.file <- sprintf('%s/results/OMI/normalized_raw_values.csv',REPO_HOME)
