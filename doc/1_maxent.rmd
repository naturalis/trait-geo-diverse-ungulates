...
# the stacking of all the suitability rasters uses a lot of memory. You can change 1: lenth(taxa) to for example the first 20 species 1:20. When calculating the Schoener's distance in {calc_dist} all the suitability rasters need to be stacked and therefore it is recommended to use a computer with sufficient memory. 
for ( i in 1:length(taxa) ) {
