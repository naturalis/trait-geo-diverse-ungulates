...
overlap.file <- paste(REPO_HOME, '/results/maxent/gowers_overlap_MaxEnt_occurencepoints.csv', sep = '')
# load data
...
```{r omi}
omi.file <- sprintf('%s/results/OMI/normalized_MaxEnt_values.csv',REPO_HOME)
