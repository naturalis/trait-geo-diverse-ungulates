...
overlap.csv <- paste(REPO_HOME, "/results/maxent/comparative/gower/raw_omi.csv", sep="")
...
# write tree 
tree.file <- paste(REPO_HOME, "/results/maxent/comparative/gower/raw_omi_hclust.tree", sep="")
write.tree(tree, file = tree.file)

tree.nj.file<- paste(REPO_HOME, "/results/maxent/comparative/gower/raw_omi_nj.tree", sep="")
