...
overlap.csv <- paste(REPO_HOME, "/results/maxent/gowers_overlap_raw_occurencepoints.csv", sep="")
...
# write tree 
tree.file <- paste(REPO_HOME, "/results/maxent/overlap_gower_raw_occurences_hclust.tree", sep="")
write.tree(tree, file = tree.file)

tree.nj.file<- paste(REPO_HOME, "/results/maxent/overlap_gower_raw_occurences_nj.tree", sep="")
