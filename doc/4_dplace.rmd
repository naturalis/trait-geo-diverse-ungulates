...
# extract pastoralism
subsistence.SCCS820.pastoralism  <- filter(subsistence.SCCS820, SCCS820 == 5)
subsistence.SCCS833.pastoralism  <- filter(subsistence.SCCS833, SCCS833 == 4)
#subsistence.EA042.pastoralism    <- filter(subsistence.EA042, EA042 == 4)
subsistence.SCCS1716.pastoralism <- filter(subsistence.SCCS1716, SCCS1716 == 3)
subsistence.SCCS246.pastoralism  <- filter(subsistence.SCCS246, SCCS246 == 4)

subsistence.SCCS820.pastoralism$subsistence.SCCS820   <- 'pastoralism'
subsistence.SCCS833.pastoralism$subsistence.SCCS833   <- 'pastoralism'
#subsistence.EA042.pastoralism$subsistence.EA042       <- 'pastoralism'
subsistence.SCCS1716.pastoralism$subsistence.SCCS1716 <- 'pastoralism'
subsistence.SCCS246.pastoralism$subsistence.SCCS246   <- 'pastoralism'
...
subsistence.SCCS820.agriculturalism$subsistence.SCCS820   <- 'agriculturalism'
subsistence.SCCS833.agriculturalism$subsistence.SCCS833   <- 'agriculturalism'
#subsistence.EA042.agriculturalism$subsistence.EA042       <- 'agriculturalism'
subsistence.SCCS1716.agriculturalism$subsistence.SCCS1716 <- 'agriculturalism'
subsistence.SCCS246.agriculturalism$subsistence.SCCS246   <- 'agriculturalism'
...
```{r cordisc}
data <- select(joined.df,language_glottocode,habitat,stratification.SCCS158,sedentism.SCCS150)
data$language_glottocode <- as.factor(data$language_glottocode)
data$habitat <- as.integer(data$habitat)-1
data$stratification.SCCS158 <- as.integer(data$stratification.SCCS158)-1
data$sedentism.SCCS150 <- as.integer(data$sedentism.SCCS150)-1
cd <- corDISC(tree, data, ntraits = 2, model = "ARD")
"habitat (0=pasture, 1=steppe), stratification (0=egalitarian, 1=stratified), sedentism (0=impermanent, 1=sedentary)"
cd
```