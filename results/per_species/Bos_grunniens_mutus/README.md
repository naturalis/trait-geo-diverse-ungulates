...
[occurrences](../../data/filtered/Bos grunniens mutus.csv) for Bos grunniens mutus used in 
...
The response curve graphs show the modeled response of Bos grunniens mutus to the 
...
preferences for Bos grunniens mutus calculated in the Maxent model. The second map 
