...
The response curve graphs show the modeled response of Rangifer tarandus to the 
...
preferences for Rangifer tarandus calculated in the Maxent model. The second map 
