...
[occurrences](../../data/filtered/Camelus bactrianus.csv) for Camelus bactrianus used in 
...
The response curve graphs show the modeled response of Camelus bactrianus to the 
...
preferences for Camelus bactrianus calculated in the Maxent model. The second map 
