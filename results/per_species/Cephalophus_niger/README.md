...
[occurrences](../../data/filtered/Cephalophus niger.csv) for Cephalophus niger used in 
...
The response curve graphs show the modeled response of Cephalophus niger to the 
...
preferences for Cephalophus niger calculated in the Maxent model. The second map 
