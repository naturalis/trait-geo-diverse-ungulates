...
[occurrences](../../data/filtered/Procapra picticaudata.csv) for Procapra picticaudata used in 
...
The response curve graphs show the modeled response of Procapra picticaudata to the 
...
preferences for Procapra picticaudata calculated in the Maxent model. The second map 
