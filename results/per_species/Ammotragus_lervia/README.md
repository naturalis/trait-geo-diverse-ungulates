...
[occurrences](../../data/filtered/Ammotragus lervia.csv) for Ammotragus lervia used in 
...
The response curve graphs show the modeled response of Ammotragus lervia to the 
...
preferences for Ammotragus lervia calculated in the Maxent model. The second map 
