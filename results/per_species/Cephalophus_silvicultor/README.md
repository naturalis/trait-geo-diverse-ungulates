...
The response curve graphs show the modeled response of Cephalophus silvicultor to the 
...
preferences for Cephalophus silvicultor calculated in the Maxent model. The second map 
