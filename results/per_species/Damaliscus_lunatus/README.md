...
[occurrences](../../data/filtered/Damaliscus lunatus.csv) for Damaliscus lunatus used in 
...
The response curve graphs show the modeled response of Damaliscus lunatus to the 
...
preferences for Damaliscus lunatus calculated in the Maxent model. The second map 
