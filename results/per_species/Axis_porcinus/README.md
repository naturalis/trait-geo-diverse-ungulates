...
The response curve graphs show the modeled response of Axis porcinus to the 
...
preferences for Axis porcinus calculated in the Maxent model. The second map 
