...
The response curve graphs show the modeled response of Cephalophus jentinki to the 
...
preferences for Cephalophus jentinki calculated in the Maxent model. The second map 
