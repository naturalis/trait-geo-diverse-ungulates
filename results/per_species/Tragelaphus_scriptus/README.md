...
[occurrences](../../data/filtered/Tragelaphus scriptus.csv) for Tragelaphus scriptus used in 
...
The response curve graphs show the modeled response of Tragelaphus scriptus to the 
...
preferences for Tragelaphus scriptus calculated in the Maxent model. The second map 
