...
[occurrences](../../data/filtered/Bison bison.csv) for Bison bison used in 
...
The response curve graphs show the modeled response of Bison bison to the 
...
preferences for Bison bison calculated in the Maxent model. The second map 
