...
[occurrences](../../data/filtered/Tragelaphus spekii.csv) for Tragelaphus spekii used in 
...
The response curve graphs show the modeled response of Tragelaphus spekii to the 
...
preferences for Tragelaphus spekii calculated in the Maxent model. The second map 
