...
The response curve graphs show the modeled response of Rupicapra rupicapra to the 
...
preferences for Rupicapra rupicapra calculated in the Maxent model. The second map 
