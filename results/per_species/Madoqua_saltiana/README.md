...
[occurrences](../../data/filtered/Madoqua saltiana.csv) for Madoqua saltiana used in 
...
The response curve graphs show the modeled response of Madoqua saltiana to the 
...
preferences for Madoqua saltiana calculated in the Maxent model. The second map 
