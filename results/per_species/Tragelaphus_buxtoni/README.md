...
The response curve graphs show the modeled response of Tragelaphus buxtoni to the 
...
preferences for Tragelaphus buxtoni calculated in the Maxent model. The second map 
