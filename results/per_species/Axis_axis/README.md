...
[occurrences](../../data/filtered/Axis axis.csv) for Axis axis used in 
...
The response curve graphs show the modeled response of Axis axis to the 
...
preferences for Axis axis calculated in the Maxent model. The second map 
