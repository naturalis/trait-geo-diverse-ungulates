...
The response curve graphs show the modeled response of Boselaphus tragocamelus to the 
...
preferences for Boselaphus tragocamelus calculated in the Maxent model. The second map 
