...
The response curve graphs show the modeled response of Tayassu pecari to the 
...
preferences for Tayassu pecari calculated in the Maxent model. The second map 
