...
[occurrences](../../data/filtered/Equus kiang.csv) for Equus kiang used in 
...
The response curve graphs show the modeled response of Equus kiang to the 
...
preferences for Equus kiang calculated in the Maxent model. The second map 
