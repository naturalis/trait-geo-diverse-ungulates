...
[occurrences](../../data/filtered/Rusa timorensis.csv) for Rusa timorensis used in 
...
The response curve graphs show the modeled response of Rusa timorensis to the 
...
preferences for Rusa timorensis calculated in the Maxent model. The second map 
