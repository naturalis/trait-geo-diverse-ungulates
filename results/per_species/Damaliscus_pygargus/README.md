...
[occurrences](../../data/filtered/Damaliscus pygargus.csv) for Damaliscus pygargus used in 
...
The response curve graphs show the modeled response of Damaliscus pygargus to the 
...
preferences for Damaliscus pygargus calculated in the Maxent model. The second map 
