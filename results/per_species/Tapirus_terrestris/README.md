...
[occurrences](../../data/filtered/Tapirus terrestris.csv) for Tapirus terrestris used in 
...
The response curve graphs show the modeled response of Tapirus terrestris to the 
...
preferences for Tapirus terrestris calculated in the Maxent model. The second map 
