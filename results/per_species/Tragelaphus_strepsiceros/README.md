...
[occurrences](../../data/filtered/Tragelaphus strepsiceros.csv) for Tragelaphus strepsiceros used in 
...
The response curve graphs show the modeled response of Tragelaphus strepsiceros to the 
...
preferences for Tragelaphus strepsiceros calculated in the Maxent model. The second map 
