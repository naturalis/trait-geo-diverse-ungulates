...
The response curve graphs show the modeled response of Hippopotamus amphibius to the 
...
preferences for Hippopotamus amphibius calculated in the Maxent model. The second map 
