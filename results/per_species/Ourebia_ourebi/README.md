...
[occurrences](../../data/filtered/Ourebia ourebi.csv) for Ourebia ourebi used in 
...
The response curve graphs show the modeled response of Ourebia ourebi to the 
...
preferences for Ourebia ourebi calculated in the Maxent model. The second map 
