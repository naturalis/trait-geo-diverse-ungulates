...
[occurrences](../../data/filtered/Mazama americana.csv) for Mazama americana used in 
...
The response curve graphs show the modeled response of Mazama americana to the 
...
preferences for Mazama americana calculated in the Maxent model. The second map 
