...
[occurrences](../../data/filtered/Diceros bicornis.csv) for Diceros bicornis used in 
...
The response curve graphs show the modeled response of Diceros bicornis to the 
...
preferences for Diceros bicornis calculated in the Maxent model. The second map 
