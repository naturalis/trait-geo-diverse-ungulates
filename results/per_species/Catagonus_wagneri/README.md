...
[occurrences](../../data/filtered/Catagonus wagneri.csv) for Catagonus wagneri used in 
...
The response curve graphs show the modeled response of Catagonus wagneri to the 
...
preferences for Catagonus wagneri calculated in the Maxent model. The second map 
