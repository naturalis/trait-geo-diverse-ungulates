...
The response curve graphs show the modeled response of Capra hircus aegagrus to the 
...
preferences for Capra hircus aegagrus calculated in the Maxent model. The second map 
