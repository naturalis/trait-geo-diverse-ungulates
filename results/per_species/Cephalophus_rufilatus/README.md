...
[occurrences](../../data/filtered/Cephalophus rufilatus.csv) for Cephalophus rufilatus used in 
...
The response curve graphs show the modeled response of Cephalophus rufilatus to the 
...
preferences for Cephalophus rufilatus calculated in the Maxent model. The second map 
