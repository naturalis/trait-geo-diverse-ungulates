...
[occurrences](../../data/filtered/Kobus kob.csv) for Kobus kob used in 
...
The response curve graphs show the modeled response of Kobus kob to the 
...
preferences for Kobus kob calculated in the Maxent model. The second map 
