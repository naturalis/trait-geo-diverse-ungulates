...
The response curve graphs show the modeled response of Ovis aries orientalis to the 
...
preferences for Ovis aries orientalis calculated in the Maxent model. The second map 
