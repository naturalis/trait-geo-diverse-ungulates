...
[occurrences](../../data/filtered/Madoqua guentheri.csv) for Madoqua guentheri used in 
...
The response curve graphs show the modeled response of Madoqua guentheri to the 
...
preferences for Madoqua guentheri calculated in the Maxent model. The second map 
