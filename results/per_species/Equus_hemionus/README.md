...
The response curve graphs show the modeled response of Equus hemionus to the 
...
preferences for Equus hemionus calculated in the Maxent model. The second map 
