...
[occurrences](../../data/filtered/Capra nubiana.csv) for Capra nubiana used in 
...
The response curve graphs show the modeled response of Capra nubiana to the 
...
preferences for Capra nubiana calculated in the Maxent model. The second map 
