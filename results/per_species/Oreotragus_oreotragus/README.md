...
[occurrences](../../data/filtered/Oreotragus oreotragus.csv) for Oreotragus oreotragus used in 
...
The response curve graphs show the modeled response of Oreotragus oreotragus to the 
...
preferences for Oreotragus oreotragus calculated in the Maxent model. The second map 
