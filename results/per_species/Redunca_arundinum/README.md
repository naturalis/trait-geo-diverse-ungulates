...
The response curve graphs show the modeled response of Redunca arundinum to the 
...
preferences for Redunca arundinum calculated in the Maxent model. The second map 
