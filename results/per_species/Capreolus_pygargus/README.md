...
[occurrences](../../data/filtered/Capreolus pygargus.csv) for Capreolus pygargus used in 
...
The response curve graphs show the modeled response of Capreolus pygargus to the 
...
preferences for Capreolus pygargus calculated in the Maxent model. The second map 
