...
[occurrences](../../data/filtered/Pecari tajacu.csv) for Pecari tajacu used in 
...
The response curve graphs show the modeled response of Pecari tajacu to the 
...
preferences for Pecari tajacu calculated in the Maxent model. The second map 
