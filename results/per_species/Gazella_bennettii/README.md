...
[occurrences](../../data/filtered/Gazella bennettii.csv) for Gazella bennettii used in 
...
The response curve graphs show the modeled response of Gazella bennettii to the 
...
preferences for Gazella bennettii calculated in the Maxent model. The second map 
