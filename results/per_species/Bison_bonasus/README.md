...
The response curve graphs show the modeled response of Bison bonasus to the 
...
preferences for Bison bonasus calculated in the Maxent model. The second map 
