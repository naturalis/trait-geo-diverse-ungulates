...
[occurrences](../../data/filtered/Phacochoerus africanus.csv) for Phacochoerus africanus used in 
...
The response curve graphs show the modeled response of Phacochoerus africanus to the 
...
preferences for Phacochoerus africanus calculated in the Maxent model. The second map 
