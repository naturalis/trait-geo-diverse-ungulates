...
The response curve graphs show the modeled response of Neotragus batesi to the 
...
preferences for Neotragus batesi calculated in the Maxent model. The second map 
