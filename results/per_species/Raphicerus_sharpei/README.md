...
[occurrences](../../data/filtered/Raphicerus sharpei.csv) for Raphicerus sharpei used in 
...
The response curve graphs show the modeled response of Raphicerus sharpei to the 
...
preferences for Raphicerus sharpei calculated in the Maxent model. The second map 
