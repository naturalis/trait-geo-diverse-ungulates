...
The response curve graphs show the modeled response of Cervus elaphus to the 
...
preferences for Cervus elaphus calculated in the Maxent model. The second map 
