...
[occurrences](../../data/filtered/Oryx beisa.csv) for Oryx beisa used in 
...
The response curve graphs show the modeled response of Oryx beisa to the 
...
preferences for Oryx beisa calculated in the Maxent model. The second map 
