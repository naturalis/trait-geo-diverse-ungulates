...
[occurrences](../../data/filtered/Tragulus napu.csv) for Tragulus napu used in 
...
The response curve graphs show the modeled response of Tragulus napu to the 
...
preferences for Tragulus napu calculated in the Maxent model. The second map 
