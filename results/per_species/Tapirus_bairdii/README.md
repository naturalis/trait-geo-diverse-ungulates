...
[occurrences](../../data/filtered/Tapirus bairdii.csv) for Tapirus bairdii used in 
...
The response curve graphs show the modeled response of Tapirus bairdii to the 
...
preferences for Tapirus bairdii calculated in the Maxent model. The second map 
