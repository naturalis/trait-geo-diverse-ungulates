...
[occurrences](../../data/filtered/Mazama pandora.csv) for Mazama pandora used in 
...
The response curve graphs show the modeled response of Mazama pandora to the 
...
preferences for Mazama pandora calculated in the Maxent model. The second map 
