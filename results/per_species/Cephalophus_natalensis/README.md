...
[occurrences](../../data/filtered/Cephalophus natalensis.csv) for Cephalophus natalensis used in 
...
The response curve graphs show the modeled response of Cephalophus natalensis to the 
...
preferences for Cephalophus natalensis calculated in the Maxent model. The second map 
