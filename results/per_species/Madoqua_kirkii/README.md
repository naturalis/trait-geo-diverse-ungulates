...
[occurrences](../../data/filtered/Madoqua kirkii.csv) for Madoqua kirkii used in 
...
The response curve graphs show the modeled response of Madoqua kirkii to the 
...
preferences for Madoqua kirkii calculated in the Maxent model. The second map 
