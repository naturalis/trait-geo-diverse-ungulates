...
[occurrences](../../data/filtered/Kobus megaceros.csv) for Kobus megaceros used in 
...
The response curve graphs show the modeled response of Kobus megaceros to the 
...
preferences for Kobus megaceros calculated in the Maxent model. The second map 
