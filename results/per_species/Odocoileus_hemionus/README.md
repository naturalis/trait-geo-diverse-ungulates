...
[occurrences](../../data/filtered/Odocoileus hemionus.csv) for Odocoileus hemionus used in 
...
The response curve graphs show the modeled response of Odocoileus hemionus to the 
...
preferences for Odocoileus hemionus calculated in the Maxent model. The second map 
