...
[occurrences](../../data/filtered/Muntiacus muntjak.csv) for Muntiacus muntjak used in 
...
The response curve graphs show the modeled response of Muntiacus muntjak to the 
...
preferences for Muntiacus muntjak calculated in the Maxent model. The second map 
