...
[occurrences](../../data/filtered/Muntiacus reevesi.csv) for Muntiacus reevesi used in 
...
The response curve graphs show the modeled response of Muntiacus reevesi to the 
...
preferences for Muntiacus reevesi calculated in the Maxent model. The second map 
