...
[occurrences](../../data/filtered/Sus cebifrons.csv) for Sus cebifrons used in 
...
The response curve graphs show the modeled response of Sus cebifrons to the 
...
preferences for Sus cebifrons calculated in the Maxent model. The second map 
