...
[occurrences](../../data/filtered/Tragelaphus imberbis.csv) for Tragelaphus imberbis used in 
...
The response curve graphs show the modeled response of Tragelaphus imberbis to the 
...
preferences for Tragelaphus imberbis calculated in the Maxent model. The second map 
