...
The response curve graphs show the modeled response of Hemitragus jemlahicus to the 
...
preferences for Hemitragus jemlahicus calculated in the Maxent model. The second map 
