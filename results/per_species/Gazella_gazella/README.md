...
[occurrences](../../data/filtered/Gazella gazella.csv) for Gazella gazella used in 
...
The response curve graphs show the modeled response of Gazella gazella to the 
...
preferences for Gazella gazella calculated in the Maxent model. The second map 
