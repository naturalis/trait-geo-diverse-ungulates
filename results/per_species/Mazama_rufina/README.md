...
[occurrences](../../data/filtered/Mazama rufina.csv) for Mazama rufina used in 
...
The response curve graphs show the modeled response of Mazama rufina to the 
...
preferences for Mazama rufina calculated in the Maxent model. The second map 
