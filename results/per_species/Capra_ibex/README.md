...
[occurrences](../../data/filtered/Capra ibex.csv) for Capra ibex used in 
...
The response curve graphs show the modeled response of Capra ibex to the 
...
preferences for Capra ibex calculated in the Maxent model. The second map 
