...
The response curve graphs show the modeled response of Hippotragus equinus to the 
...
preferences for Hippotragus equinus calculated in the Maxent model. The second map 
