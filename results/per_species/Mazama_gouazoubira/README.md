...
The response curve graphs show the modeled response of Mazama gouazoubira to the 
...
preferences for Mazama gouazoubira calculated in the Maxent model. The second map 
