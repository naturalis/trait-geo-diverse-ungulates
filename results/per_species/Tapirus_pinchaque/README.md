...
[occurrences](../../data/filtered/Tapirus pinchaque.csv) for Tapirus pinchaque used in 
...
The response curve graphs show the modeled response of Tapirus pinchaque to the 
...
preferences for Tapirus pinchaque calculated in the Maxent model. The second map 
