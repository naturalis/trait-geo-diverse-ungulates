...
[occurrences](../../data/filtered/Pseudois nayaur.csv) for Pseudois nayaur used in 
...
The response curve graphs show the modeled response of Pseudois nayaur to the 
...
preferences for Pseudois nayaur calculated in the Maxent model. The second map 
