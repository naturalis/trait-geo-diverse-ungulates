...
[occurrences](../../data/filtered/Capra sibirica.csv) for Capra sibirica used in 
...
The response curve graphs show the modeled response of Capra sibirica to the 
...
preferences for Capra sibirica calculated in the Maxent model. The second map 
