...
[occurrences](../../data/filtered/Pelea capreolus.csv) for Pelea capreolus used in 
...
The response curve graphs show the modeled response of Pelea capreolus to the 
...
preferences for Pelea capreolus calculated in the Maxent model. The second map 
