...
The response curve graphs show the modeled response of Nanger granti to the 
...
preferences for Nanger granti calculated in the Maxent model. The second map 
