...
[occurrences](../../data/filtered/Equus przewalskii.csv) for Equus przewalskii used in 
...
The response curve graphs show the modeled response of Equus przewalskii to the 
...
preferences for Equus przewalskii calculated in the Maxent model. The second map 
