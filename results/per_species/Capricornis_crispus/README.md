...
[occurrences](../../data/filtered/Capricornis crispus.csv) for Capricornis crispus used in 
...
The response curve graphs show the modeled response of Capricornis crispus to the 
...
preferences for Capricornis crispus calculated in the Maxent model. The second map 
