...
The response curve graphs show the modeled response of Capricornis swinhoei to the 
...
preferences for Capricornis swinhoei calculated in the Maxent model. The second map 
