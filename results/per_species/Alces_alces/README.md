...
[occurrences](../../data/filtered/Alces alces.csv) for Alces alces used in 
...
The response curve graphs show the modeled response of Alces alces to the 
...
preferences for Alces alces calculated in the Maxent model. The second map 
