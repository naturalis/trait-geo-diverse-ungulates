...
[occurrences](../../data/filtered/Bos javanicus.csv) for Bos javanicus used in 
...
The response curve graphs show the modeled response of Bos javanicus to the 
...
preferences for Bos javanicus calculated in the Maxent model. The second map 
