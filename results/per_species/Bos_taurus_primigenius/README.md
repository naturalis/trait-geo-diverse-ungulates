...
[occurrences](../../data/filtered/Bos taurus primigenius.csv) for Bos taurus primigenius used in 
...
The response curve graphs show the modeled response of Bos taurus primigenius to the 
...
preferences for Bos taurus primigenius calculated in the Maxent model. The second map 
