...
[occurrences](../../data/filtered/Syncerus caffer.csv) for Syncerus caffer used in 
...
The response curve graphs show the modeled response of Syncerus caffer to the 
...
preferences for Syncerus caffer calculated in the Maxent model. The second map 
