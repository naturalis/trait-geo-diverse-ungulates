...
[occurrences](../../data/filtered/Philantomba maxwellii.csv) for Philantomba maxwellii used in 
...
The response curve graphs show the modeled response of Philantomba maxwellii to the 
...
preferences for Philantomba maxwellii calculated in the Maxent model. The second map 
