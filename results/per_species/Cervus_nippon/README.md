...
[occurrences](../../data/filtered/Cervus nippon.csv) for Cervus nippon used in 
...
The response curve graphs show the modeled response of Cervus nippon to the 
...
preferences for Cervus nippon calculated in the Maxent model. The second map 
