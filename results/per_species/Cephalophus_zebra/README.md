...
[occurrences](../../data/filtered/Cephalophus zebra.csv) for Cephalophus zebra used in 
...
The response curve graphs show the modeled response of Cephalophus zebra to the 
...
preferences for Cephalophus zebra calculated in the Maxent model. The second map 
