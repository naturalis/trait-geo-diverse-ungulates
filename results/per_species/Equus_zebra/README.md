...
[occurrences](../../data/filtered/Equus zebra.csv) for Equus zebra used in 
...
The response curve graphs show the modeled response of Equus zebra to the 
...
preferences for Equus zebra calculated in the Maxent model. The second map 
