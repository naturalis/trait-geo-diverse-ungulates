...
[occurrences](../../data/filtered/Antilope cervicapra.csv) for Antilope cervicapra used in 
...
The response curve graphs show the modeled response of Antilope cervicapra to the 
...
preferences for Antilope cervicapra calculated in the Maxent model. The second map 
