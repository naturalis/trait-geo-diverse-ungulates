...
[occurrences](../../data/filtered/Ovis ammon.csv) for Ovis ammon used in 
...
The response curve graphs show the modeled response of Ovis ammon to the 
...
preferences for Ovis ammon calculated in the Maxent model. The second map 
