...
[occurrences](../../data/filtered/Kobus leche.csv) for Kobus leche used in 
...
The response curve graphs show the modeled response of Kobus leche to the 
...
preferences for Kobus leche calculated in the Maxent model. The second map 
