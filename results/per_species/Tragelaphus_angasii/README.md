...
[occurrences](../../data/filtered/Tragelaphus angasii.csv) for Tragelaphus angasii used in 
...
The response curve graphs show the modeled response of Tragelaphus angasii to the 
...
preferences for Tragelaphus angasii calculated in the Maxent model. The second map 
