...
[occurrences](../../data/filtered/Budorcas taxicolor.csv) for Budorcas taxicolor used in 
...
The response curve graphs show the modeled response of Budorcas taxicolor to the 
...
preferences for Budorcas taxicolor calculated in the Maxent model. The second map 
