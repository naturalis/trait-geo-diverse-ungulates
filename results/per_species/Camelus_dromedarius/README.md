...
[occurrences](../../data/filtered/Camelus dromedarius.csv) for Camelus dromedarius used in 
...
The response curve graphs show the modeled response of Camelus dromedarius to the 
...
preferences for Camelus dromedarius calculated in the Maxent model. The second map 
