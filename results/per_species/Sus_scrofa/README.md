...
[occurrences](../../data/filtered/Sus scrofa.csv) for Sus scrofa used in 
...
The response curve graphs show the modeled response of Sus scrofa to the 
...
preferences for Sus scrofa calculated in the Maxent model. The second map 
