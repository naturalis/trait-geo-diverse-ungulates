...
[occurrences](../../data/filtered/Alcelaphus buselaphus.csv) for Alcelaphus buselaphus used in 
...
The response curve graphs show the modeled response of Alcelaphus buselaphus to the 
...
preferences for Alcelaphus buselaphus calculated in the Maxent model. The second map 
