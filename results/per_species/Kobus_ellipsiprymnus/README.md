...
[occurrences](../../data/filtered/Kobus ellipsiprymnus.csv) for Kobus ellipsiprymnus used in 
...
The response curve graphs show the modeled response of Kobus ellipsiprymnus to the 
...
preferences for Kobus ellipsiprymnus calculated in the Maxent model. The second map 
