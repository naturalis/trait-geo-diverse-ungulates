...
The response curve graphs show the modeled response of Hylochoerus meinertzhageni to the 
...
preferences for Hylochoerus meinertzhageni calculated in the Maxent model. The second map 
