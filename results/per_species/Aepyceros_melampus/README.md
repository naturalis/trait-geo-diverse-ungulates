...
[occurrences](../../data/filtered/Aepyceros melampus.csv) for Aepyceros melampus used in 
...
The response curve graphs show the modeled response of Aepyceros melampus to the 
...
preferences for Aepyceros melampus calculated in the Maxent model. The second map 
