...
[occurrences](../../data/filtered/Redunca redunca.csv) for Redunca redunca used in 
...
The response curve graphs show the modeled response of Redunca redunca to the 
...
preferences for Redunca redunca calculated in the Maxent model. The second map 
