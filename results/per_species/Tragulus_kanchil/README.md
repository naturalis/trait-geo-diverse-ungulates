...
[occurrences](../../data/filtered/Tragulus kanchil.csv) for Tragulus kanchil used in 
...
The response curve graphs show the modeled response of Tragulus kanchil to the 
...
preferences for Tragulus kanchil calculated in the Maxent model. The second map 
