...
The response curve graphs show the modeled response of Antilocapra americana to the 
...
preferences for Antilocapra americana calculated in the Maxent model. The second map 
