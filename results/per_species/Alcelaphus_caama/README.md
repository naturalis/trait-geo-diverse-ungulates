...
[occurrences](../../data/filtered/Alcelaphus caama.csv) for Alcelaphus caama used in 
...
The response curve graphs show the modeled response of Alcelaphus caama to the 
...
preferences for Alcelaphus caama calculated in the Maxent model. The second map 
