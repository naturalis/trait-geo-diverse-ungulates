...
[occurrences](../../data/filtered/Ovis canadensis.csv) for Ovis canadensis used in 
...
The response curve graphs show the modeled response of Ovis canadensis to the 
...
preferences for Ovis canadensis calculated in the Maxent model. The second map 
