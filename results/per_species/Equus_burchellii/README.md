...
[occurrences](../../data/filtered/Equus burchellii.csv) for Equus burchellii used in 
...
The response curve graphs show the modeled response of Equus burchellii to the 
...
preferences for Equus burchellii calculated in the Maxent model. The second map 
