...
[occurrences](../../data/filtered/Vicugna vicugna.csv) for Vicugna vicugna used in 
...
The response curve graphs show the modeled response of Vicugna vicugna to the 
...
preferences for Vicugna vicugna calculated in the Maxent model. The second map 
