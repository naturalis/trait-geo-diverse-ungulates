...
[occurrences](../../data/filtered/Neotragus pygmaeus.csv) for Neotragus pygmaeus used in 
...
The response curve graphs show the modeled response of Neotragus pygmaeus to the 
...
preferences for Neotragus pygmaeus calculated in the Maxent model. The second map 
