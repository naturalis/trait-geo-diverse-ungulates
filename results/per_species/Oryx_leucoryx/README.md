...
The response curve graphs show the modeled response of Oryx leucoryx to the 
...
preferences for Oryx leucoryx calculated in the Maxent model. The second map 
