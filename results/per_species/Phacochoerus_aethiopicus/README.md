...
The response curve graphs show the modeled response of Phacochoerus aethiopicus to the 
...
preferences for Phacochoerus aethiopicus calculated in the Maxent model. The second map 
