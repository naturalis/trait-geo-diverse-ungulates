...
[occurrences](../../data/filtered/Bubalus bubalis arnee.csv) for Bubalus bubalis arnee used in 
...
The response curve graphs show the modeled response of Bubalus bubalis arnee to the 
...
preferences for Bubalus bubalis arnee calculated in the Maxent model. The second map 
