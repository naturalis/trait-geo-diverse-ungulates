...
[occurrences](../../data/filtered/Eudorcas rufifrons.csv) for Eudorcas rufifrons used in 
...
The response curve graphs show the modeled response of Eudorcas rufifrons to the 
...
preferences for Eudorcas rufifrons calculated in the Maxent model. The second map 
