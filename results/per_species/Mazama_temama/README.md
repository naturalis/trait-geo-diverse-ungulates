...
[occurrences](../../data/filtered/Mazama temama.csv) for Mazama temama used in 
...
The response curve graphs show the modeled response of Mazama temama to the 
...
preferences for Mazama temama calculated in the Maxent model. The second map 
