...
[occurrences](../../data/filtered/Equus grevyi.csv) for Equus grevyi used in 
...
The response curve graphs show the modeled response of Equus grevyi to the 
...
preferences for Equus grevyi calculated in the Maxent model. The second map 
