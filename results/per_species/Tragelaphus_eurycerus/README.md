...
The response curve graphs show the modeled response of Tragelaphus eurycerus to the 
...
preferences for Tragelaphus eurycerus calculated in the Maxent model. The second map 
