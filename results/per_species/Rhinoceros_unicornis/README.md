...
[occurrences](../../data/filtered/Rhinoceros unicornis.csv) for Rhinoceros unicornis used in 
...
The response curve graphs show the modeled response of Rhinoceros unicornis to the 
...
preferences for Rhinoceros unicornis calculated in the Maxent model. The second map 
