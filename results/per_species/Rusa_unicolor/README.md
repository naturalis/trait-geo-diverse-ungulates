...
[occurrences](../../data/filtered/Rusa unicolor.csv) for Rusa unicolor used in 
...
The response curve graphs show the modeled response of Rusa unicolor to the 
...
preferences for Rusa unicolor calculated in the Maxent model. The second map 
