...
[occurrences](../../data/filtered/Sylvicapra grimmia.csv) for Sylvicapra grimmia used in 
...
The response curve graphs show the modeled response of Sylvicapra grimmia to the 
...
preferences for Sylvicapra grimmia calculated in the Maxent model. The second map 
