...
[occurrences](../../data/filtered/Kobus vardonii.csv) for Kobus vardonii used in 
...
The response curve graphs show the modeled response of Kobus vardonii to the 
...
preferences for Kobus vardonii calculated in the Maxent model. The second map 
