...
The response curve graphs show the modeled response of Capreolus capreolus to the 
...
preferences for Capreolus capreolus calculated in the Maxent model. The second map 
