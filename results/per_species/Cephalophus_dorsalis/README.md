...
[occurrences](../../data/filtered/Cephalophus dorsalis.csv) for Cephalophus dorsalis used in 
...
The response curve graphs show the modeled response of Cephalophus dorsalis to the 
...
preferences for Cephalophus dorsalis calculated in the Maxent model. The second map 
