...
[occurrences](../../data/filtered/Capra pyrenaica.csv) for Capra pyrenaica used in 
...
The response curve graphs show the modeled response of Capra pyrenaica to the 
...
preferences for Capra pyrenaica calculated in the Maxent model. The second map 
