...
[occurrences](../../data/filtered/Litocranius walleri.csv) for Litocranius walleri used in 
...
The response curve graphs show the modeled response of Litocranius walleri to the 
...
preferences for Litocranius walleri calculated in the Maxent model. The second map 
