...
The response curve graphs show the modeled response of Rucervus duvaucelii to the 
...
preferences for Rucervus duvaucelii calculated in the Maxent model. The second map 
