...
The response curve graphs show the modeled response of Hippocamelus antisensis to the 
...
preferences for Hippocamelus antisensis calculated in the Maxent model. The second map 
