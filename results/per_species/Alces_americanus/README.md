...
[occurrences](../../data/filtered/Alces americanus.csv) for Alces americanus used in 
...
The response curve graphs show the modeled response of Alces americanus to the 
...
preferences for Alces americanus calculated in the Maxent model. The second map 
