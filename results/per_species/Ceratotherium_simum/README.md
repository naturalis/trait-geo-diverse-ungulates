...
The response curve graphs show the modeled response of Ceratotherium simum to the 
...
preferences for Ceratotherium simum calculated in the Maxent model. The second map 
