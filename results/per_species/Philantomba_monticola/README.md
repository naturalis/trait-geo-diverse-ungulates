...
[occurrences](../../data/filtered/Philantomba monticola.csv) for Philantomba monticola used in 
...
The response curve graphs show the modeled response of Philantomba monticola to the 
...
preferences for Philantomba monticola calculated in the Maxent model. The second map 
