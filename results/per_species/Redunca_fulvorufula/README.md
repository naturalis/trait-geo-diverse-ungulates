...
[occurrences](../../data/filtered/Redunca fulvorufula.csv) for Redunca fulvorufula used in 
...
The response curve graphs show the modeled response of Redunca fulvorufula to the 
...
preferences for Redunca fulvorufula calculated in the Maxent model. The second map 
