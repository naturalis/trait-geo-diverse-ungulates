...
[occurrences](../../data/filtered/Bos frontalis gaurus.csv) for Bos frontalis gaurus used in 
...
The response curve graphs show the modeled response of Bos frontalis gaurus to the 
...
preferences for Bos frontalis gaurus calculated in the Maxent model. The second map 
