...
[occurrences](../../data/filtered/Sus barbatus.csv) for Sus barbatus used in 
...
The response curve graphs show the modeled response of Sus barbatus to the 
...
preferences for Sus barbatus calculated in the Maxent model. The second map 
