...
[occurrences](../../data/filtered/Ovis dalli.csv) for Ovis dalli used in 
...
The response curve graphs show the modeled response of Ovis dalli to the 
...
preferences for Ovis dalli calculated in the Maxent model. The second map 
