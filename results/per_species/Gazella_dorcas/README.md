...
[occurrences](../../data/filtered/Gazella dorcas.csv) for Gazella dorcas used in 
...
The response curve graphs show the modeled response of Gazella dorcas to the 
...
preferences for Gazella dorcas calculated in the Maxent model. The second map 
