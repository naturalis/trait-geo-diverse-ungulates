...
[occurrences](../../data/filtered/Rupicapra pyrenaica.csv) for Rupicapra pyrenaica used in 
...
The response curve graphs show the modeled response of Rupicapra pyrenaica to the 
...
preferences for Rupicapra pyrenaica calculated in the Maxent model. The second map 
