...
[occurrences](../../data/filtered/Ovibos moschatus.csv) for Ovibos moschatus used in 
...
The response curve graphs show the modeled response of Ovibos moschatus to the 
...
preferences for Ovibos moschatus calculated in the Maxent model. The second map 
