...
[occurrences](../../data/filtered/Ozotoceros bezoarticus.csv) for Ozotoceros bezoarticus used in 
...
The response curve graphs show the modeled response of Ozotoceros bezoarticus to the 
...
preferences for Ozotoceros bezoarticus calculated in the Maxent model. The second map 
