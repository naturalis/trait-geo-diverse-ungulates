...
[occurrences](../../data/filtered/Nanger soemmerringii.csv) for Nanger soemmerringii used in 
...
The response curve graphs show the modeled response of Nanger soemmerringii to the 
...
preferences for Nanger soemmerringii calculated in the Maxent model. The second map 
