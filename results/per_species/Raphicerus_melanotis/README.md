...
[occurrences](../../data/filtered/Raphicerus melanotis.csv) for Raphicerus melanotis used in 
...
The response curve graphs show the modeled response of Raphicerus melanotis to the 
...
preferences for Raphicerus melanotis calculated in the Maxent model. The second map 
