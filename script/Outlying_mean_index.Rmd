...
```{r gowers_distance}
p<- read.csv("C:/Users/elkeh/Documents/Stage_Naturalis/Scripts_R/trait-geo-diverse-ungulates/Results/OMI/normalized_values.csv")

# set names of species to rownames
tree.withouthnames<-p[,-1]
rownames(tree.withouthnames) <- p[,1]
