...
```{r, message=FALSE, results='hide',fig.keep='all', warnings=FALSE}
...
name <- paste(t[i,1])
list_species_model[[name]] <-species_model
}
```
...
open_species_model<-list_species_model[[1]]
# plot the variable importance
plot(open_species_model, res = 130)
...
for (i in 1:5){
  open_species_model<-list_species_model[[i]]
...
p=5  
title<- paste("Prediction map of ", t[p,1], sep="")
